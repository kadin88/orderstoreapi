class ServicosController < ApplicationController
  ...
  private
    ...
    def servico_params
      params.require(:servico).permit(:cliente_id, :pago, :data_servico, :data_pagamento, :tipo, :qt_looks, :qt_videos, :valor_sessao, :valor_extra, :valor_total, :comissao, :desconto, :obs)
    end
end
